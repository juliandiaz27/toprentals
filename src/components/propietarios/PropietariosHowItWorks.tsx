...
import type { PropietariosHowItWorksContent } from "@/lib/pageContent/propietariosTypes";

type Props = { content: PropietariosHowItWorksContent };

export function PropietariosHowItWorks({ content }: Props) {
  return (
